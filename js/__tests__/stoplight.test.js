...
test("when state is green, calling .change() should transition to yellow", () => {
    const stoplight = new Stoplight()
    stoplight.change() // from red (initial state) to green
    expect(stoplight.state).toEqual('green')
...
test("when state is yellow, calling .change() should transition to red", () => {
    const stoplight = new Stoplight()
    stoplight.change() // from red (initial state) to green
    stoplight.change() // from green to yellow
    expect(stoplight.state).toEqual('yellow')
...
test("when state is not valid, calling .change() should throw an error", () => {
    const stoplight = new Stoplight()
